...
public class TLRPC$TL_channel_layer72 extends TLRPC$TL_channel {
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        this.flags = i5;
        int i6 = this.megagroup ? i5 | MessagesController.UPDATE_MASK_READ_DIALOG_MESSAGE : i5 & -257;
        this.flags = i6;
        int i7 = this.restricted ? i6 | MessagesController.UPDATE_MASK_SELECT_DIALOG : i6 & -513;
        this.flags = i7;
        int i8 = this.signatures ? i7 | MessagesController.UPDATE_MASK_NEW_MESSAGE : i7 & -2049;
        this.flags = i8;
        int i9 = this.min ? i8 | MessagesController.UPDATE_MASK_SEND_STATE : i8 & -4097;
        this.flags = i9;
