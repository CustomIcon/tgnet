...
public class TLRPC$TL_messageFwdHeader_layer68 extends TLRPC$TL_messageFwdHeader {
    ...
    public void readParams(AbstractSerializedData abstractSerializedData, boolean z) {
        ...
        if ((readInt32 & 1) != 0) {
            ...
            tLRPC$TL_peerChannel.user_id = abstractSerializedData.readInt32(z);
        }
        this.date = abstractSerializedData.readInt32(z);
        if ((this.flags & 2) != 0) {
            TLRPC$TL_peerChannel tLRPC$TL_peerChannel2 = new TLRPC$TL_peerChannel();
            this.from_id = tLRPC$TL_peerChannel2;
            tLRPC$TL_peerChannel2.channel_id = abstractSerializedData.readInt32(z);
        }
        if ((this.flags & 4) != 0) {
    ...
    public void serializeToStream(AbstractSerializedData abstractSerializedData) {
        ...
        if ((this.flags & 2) != 0) {
            abstractSerializedData.writeInt32(this.from_id.channel_id);
        }
        if ((this.flags & 4) != 0) {
